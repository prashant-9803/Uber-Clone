  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between">
        <h3 className="font-medium text-lg p-2">New ride available!</h3>
        <div
          onClick={() => {
      ...
      <div className="flex flex-col justify-between items-center  px-5 py-2">
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <div className="flex flex-row-reverse w-full items-center justify-between mt-4">
          <button
          onClick={() => {
        ...
        <button
          ...
          className="w-full rounded-lg text-gray-500 text-base tracking-tighter px-8 py-2"
        >
          Ignore
        </button>
          </div>
